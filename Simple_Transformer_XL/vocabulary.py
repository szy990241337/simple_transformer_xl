...
class Vocab(object):
  ...
  def tokenize(self, line, add_eos=False, add_double_eos=False):
    # split a sentence；return a list containing words
    line = line.strip()
  ...
  def _build_from_file(self, vocab_file):
    ...
    self.unk_idx = self.sym2idx['<unk>'] # 这个'unk'是从词表中来的。
  ...
  def build_vocab(self):
    ...
    if self.vocab_file:
      ...
      for sym, cnt in self.counter.most_common(self.max_size):    # self.max_size限定词表的最大数量
